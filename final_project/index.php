...
function display(){
    global $dbConn;
    if($_GET['query']!= "" && $_GET['category']=="" && $_GET['price']==""){
        $proName = $_GET['query'];
    ...
    else if($_GET['query']!=""&& $_GET['category']!="" && $_GET['price']!=""){
        $num = $_GET['category'];
        $orderBy = $_GET["price"];
    ...
    echo "</table>"; 
     ...
     else if($_GET['category']!="" && $_GET['price']!=""){
        $num = $_GET['category'];
    ...
    echo "</table>"; 
      ...
      else if($_GET['query']!="" && $_GET['category']=="" ){
        $proName = $_GET['query'];
        $orderBy = $_GET["price"];
            $sql = "SELECT * FROM `product`productName LIKE '%$proName%' ORDER BY productPrice $orderBy";
		        $stmt = $dbConn->query($sql);	
		        $stmt->execute();
                $records = $stmt->fetchALL(PDO::FETCH_ASSOC);
        echo "<table border=1 id='customer'>";
...
<html>
    ...
    <body>
            ...
            <nav class='navbar navbar-default - navbar-fixed-top'>
                <div class='container-fluid'>
                    <div class='navbar-header'>
                        <a class='navbar-brand' href='#'>Guitars Galor</a>
                    </div>
        ...
        <form>  
         ...
         <div class="form-group">
                ...
                <br />
                <br />
                 <input type="button" class ="btn btn-default"  onclick="location.href='admin/index.php';" value="Admin login" />
                <br/>
                <hr>
    ...
    <footer>
        <hr>
            CST 336 Internet Programming 2018&copy; Peppmuller <br />
